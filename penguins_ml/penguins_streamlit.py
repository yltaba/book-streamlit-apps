...
st.markdown(
    """
    This app uses 6 inputs to predict the species of penguin using a model built on the Palmer's Penguin's dataset.
...
st.write('Feature importance: (Random Forest Classifier)')
